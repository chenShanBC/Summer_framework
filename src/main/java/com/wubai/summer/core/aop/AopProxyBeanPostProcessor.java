...
public class AopProxyBeanPostProcessor implements BeanPostProcessor {
    ...
    private void parseAspect(Object bean) {
        ...
        for (Method method : methods) {
            ...
            if (method.isAnnotationPresent(Before.class)) {
                ...
                System.out.println("✅ 注册切面：" + bean.getClass().getSimpleName() +
                        "." + method.getName() + " -> " + before.value());
            }
    ...
    private Object createProxy(Object bean) {
        // 1. 日志：标记正在创建代理（非核心，辅助调试）
        System.out.println("🔧 为 " + bean.getClass().getSimpleName() + " 创建 AOP 代理");
        // 2。 基于JDK动态代理
        //实现逻辑：
